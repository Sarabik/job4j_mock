...
class IndexControllerTest {
    ...
    void whenGetIndexPageExpectModelAttributeThenOk() throws JsonProcessingException {
        ...
        profile1.setId(2);
        profile1.setUsername("username2");
        ...
        Map<InterviewDTO, ProfileDTO> interviewsMap = (Map<InterviewDTO, ProfileDTO>) model.getAttribute("interviewsMap");
        ...
        assertThat(interviewsMap.keySet().stream().toList()).usingRecursiveComparison().isEqualTo(listInterviews);
        assertThat(interviewsMap.values().stream().toList()).usingRecursiveComparison().isEqualTo(List.of(profile1, profile2));
    }
}